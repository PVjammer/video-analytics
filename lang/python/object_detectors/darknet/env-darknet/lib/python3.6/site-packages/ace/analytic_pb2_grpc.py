...
class AnalyticStub(object):
  ...
  def __init__(self, channel):
    ...
    self.StreamVideoFrame = channel.stream_stream(
        ...
        response_deserializer=ace_dot_analytic__pb2.CompositeFrame.FromString,
        )
    ...
    self.FanoutFrame = channel.unary_unary(
        ...
        request_serializer=ace_dot_analytic__pb2.InputFrame.SerializeToString,
        response_deserializer=ace_dot_analytic__pb2.Empty.FromString,
        )
...
def add_AnalyticServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'StreamVideoFrame': grpc.stream_stream_rpc_method_handler(
          ...
          response_serializer=ace_dot_analytic__pb2.CompositeFrame.SerializeToString,
      ),
      ...
      'FanoutFrame': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=ace_dot_analytic__pb2.InputFrame.FromString,
          response_serializer=ace_dot_analytic__pb2.Empty.SerializeToString,
      ),
